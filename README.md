...
Подробный пошаговый сценарий со скриншотами приложения, готовыми SQL-запросами
для Adminer и ответами на контрольные вопросы — в
[docs/pokaz_lr2.md](docs/pokaz_lr2.md).
